...
runtime = importlib.import_module('local_forecast_baseline.runtime')
kernel = importlib.import_module('local_forecast_baseline.kernel')
NAME = 'forecast-baseline'
MOD = 'local_forecast_baseline'
