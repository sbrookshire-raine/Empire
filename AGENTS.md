...
# Reap dead Eve sandbox containers/volumes (dry run by default; -Apply to delete)
.\scripts\prune-sandbox-containers.ps1
.\scripts\prune-sandbox-containers.ps1 -Apply
