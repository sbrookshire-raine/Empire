...
SUITE_SLOTS: list[dict] = [
    {
        "skillId": "dailyChat",
        "label": "Daily chat",
        "description": "Default Eve voice — fast replies, tool calling, PocketBase tasks.",
        "idealId": "llama3.1:8b",
        "equivalents": ["llama3.1:latest", "llama3.2:3b", "qwen2.5:7b", "mistral:7b"],
        "sizeGb": 4.7,
        "fit16gb": "excellent",
        "why": "Best speed-to-quality on 16 GB VRAM with reliable tool use.",
        "whenToUse": "Default chat, quick questions, task CRUD, and routine agent turns.",
    },
    {
        "skillId": "coding",
        "label": "Coding",
        "description": "Repo edits, scripts, refactors, and structured code output.",
        ...
        "sizeGb": 9.0,
        "fit16gb": "good",
        "why": "14B coder tier fits VRAM while beating general models on code.",
        "whenToUse": "File edits, debugging, scaffolding, and multi-file refactors.",
    },
    {
        "skillId": "reasoning",
        "label": "Reasoning",
        "description": "Planning, decomposition, and harder multi-step problems.",
        ...
        "sizeGb": 5.2,
        "fit16gb": "excellent",
        "why": "Reasoning-tuned 8B is fast enough for daily planning without 27B offload.",
        "whenToUse": "Task breakdown, strategy, math, and chain-of-thought work.",
    },
    {
        "skillId": "deepQuality",
        "label": "Deep quality",
        "description": "Highest local IQ when latency is acceptable — keep one heavy model only.",
        "idealId": "qwen3:8b",
        "equivalents": [
            "qwen3.8:latest",
            "qwen3:14b",
            "richardyoung/qwen3.6-27b-abliterated:IQ4_XS",
            "huihui_ai/qwen3.5-abliterated:latest",
        ],
        "sizeGb": 5.2,
        "fit16gb": "excellent",
        "why": "One strong general model for hard prompts; avoid stacking multiple 27B builds.",
        "whenToUse": "Complex analysis, long-form writing, and hardest single-shot answers.",
    },
    {
        "skillId": "embedding",
        "label": "Memory embed",
