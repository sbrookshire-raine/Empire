...
SUITE_SLOTS: list[dict] = [
    {
        ...
        "idealId": "qwen2.5:14b-instruct",
        "equivalents": ["qwen2.5:14b", "qwen2.5:14b-instruct:latest"],
        "sizeGb": 9.0,
        "fit16gb": "excellent",
        "why": "Stock instruct — reliable tool JSON at temperature 0.2 on 8k context.",
        "whenToUse": "Default chat, brainstorming, quick scripts, and routine agent turns.",
    },
    {
        "skillId": "deepQuality",
        "label": "Deep Mode (Qwen3 14b)",
        "description": "Architect tier — complex planning, MCP, and deep reasoning.",
        "idealId": "qwen3:14b",
        "equivalents": ["qwen2.5:32b"],
        "sizeGb": 9.3,
        "fit16gb": "excellent",
        "why": "Newer Qwen3 reasoning with native tools; fits 16 GB without 32b offload.",
        "whenToUse": "System planning, complex MCP work, and deep sessions.",
    },
    {
        "skillId": "deepMax",
        "label": "Deep Max (32b)",
        "description": "Heaviest local IQ when you accept RAM offload.",
        "idealId": "qwen2.5:32b",
        "equivalents": [],
        "sizeGb": 19.0,
        "fit16gb": "heavy",
        "why": "Fallback when Qwen3 14b is not enough; expect slower turns on 16 GB.",
        "whenToUse": "Marathon architecture only — not default Deep.",
    },
    {
    ...
    {
        "skillId": "fastUtility",
        "label": "Fast utility (8b)",
        "description": "Low-latency fallback when VRAM is pressured (voice + chat).",
        "idealId": "qwen3:8b",
        "equivalents": ["ministral-3:8b", "llama3.1:8b", "llama3.1:latest"],
        "sizeGb": 5.2,
        "fit16gb": "excellent",
        "why": "Small resident model for quick replies when a 14b model is unloaded.",
        "whenToUse": "Routine chat when GPU lease or voice stack needs headroom.",
    },
    {
        "skillId": "vision",
        "label": "Vision / video frames",
        "description": "Screenshots, charts, UI, sampled video frames (GPU lease).",
        "idealId": "qwen3-vl:8b",
        "equivalents": ["qwen3-vl:4b"],
        "sizeGb": 6.1,
        "fit16gb": "good",
        "why": "Multimodal observe-only; Toolbelt Vision Local. Long video → FFmpeg frames first.",
        "whenToUse": "Describe images, OCR, UI observation — not Eve's default chat brain.",
    },
    {
        "skillId": "coding",
        "label": "Coding (14b)",
        "description": "Repo work, Forge, flattened code reads.",
        "idealId": "qwen2.5-coder:14b",
        "equivalents": [],
        "sizeGb": 9.0,
        "fit16gb": "excellent",
        "why": "Structured output for code tasks and Cognee graph LLM on curated ingest.",
        "whenToUse": "Cursor-style coding bursts and curated primitive cognify.",
    },
    {
        "skillId": "reasoning",
        "label": "Reasoning (R1 8b)",
        "description": "Step-by-step planning without tool loops.",
        "idealId": "deepseek-r1:8b",
        "equivalents": ["deepseek-r1:latest"],
        "sizeGb": 5.2,
        "fit16gb": "excellent",
        "why": "Chain-of-thought only — no reliable Eve MCP tool calling.",
        "whenToUse": "Plain reasoning chat; not the Eve agent driver.",
    },
    {
        "skillId": "embedding",
        "label": "Memory embed (production)",
        "description": "Cognee indexing — wired in config/cognee.env.",
        "idealId": "nomic-embed-text:latest",
        "equivalents": ["nomic-embed-text"],
        "sizeGb": 0.3,
        "fit16gb": "embed",
    ...
    {
        "skillId": "multimodalAlt",
        "label": "Multimodal alt (Gemma4 12b)",
        "description": "Benchmark for text/image/audio reasoning — not default Eve.",
        "idealId": "gemma4:12b",
        "equivalents": [],
        "sizeGb": 7.6,
        "fit16gb": "good",
        "why": "Long-context multimodal benchmark; audio input does not replace Speaches STT/TTS.",
        "whenToUse": "Compare against Qwen3-VL on hard visual docs; queue-load only.",
    },
    {
        "skillId": "embedTrial",
        "label": "Embed A/B trial",
        "description": "Optional Nomic replacement candidate — test dataset only.",
        "idealId": "qwen3-embedding:0.6b",
        "equivalents": ["qwen3-embedding:4b"],
        "sizeGb": 0.6,
        "fit16gb": "embed",
        "why": "Run docs/EMBEDDING_AB.md before changing production embed model.",
        "whenToUse": "Parallel eval on embed_ab_test — never auto-switch eve_memory.",
    },
]
...
NAME_HINTS: list[tuple[re.Pattern[str], list[str], list[str], Tier, list[str]]] = [
    ...
    (
        re.compile(r"qwen3-vl|qwen3\.vl", re.I),
        ["Screenshots", "OCR", "Video frames"],
        ["GPU lease; not default chat"],
        "specialist",
        ["vision"],
    ),
    (
        re.compile(r"qwen3-embedding|embeddinggemma", re.I),
        ["Vector memory trial"],
        ["Not for Eve chat"],
        "embed",
        ["embedTrial", "embedding"],
    ),
    (
        re.compile(r"ministral", re.I),
        ["Compact multimodal", "JSON + tools"],
        ["Benchmark vs qwen3:8b"],
        "daily",
        ["fastUtility", "dailyChat"],
    ),
    (
        re.compile(r"qwen3\.8|qwen3\.6|qwen3\.5|qwen3:8|qwen3:14|27b", re.I),
